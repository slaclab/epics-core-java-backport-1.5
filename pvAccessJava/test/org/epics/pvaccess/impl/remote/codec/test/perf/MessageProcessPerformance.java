...
public class MessageProcessPerformance extends JapexDriverBase {
    ...
    private static final int MAX_MESSAGES_IN_BUFFER = 1000;
    private static final int DEFAULT_BUFFER_SIZE = (PVAConstants.PVA_MESSAGE_HEADER_SIZE + 64) * MAX_MESSAGES_IN_BUFFER + AbstractCodec.MAX_ENSURE_SIZE;
