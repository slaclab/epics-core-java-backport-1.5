...
public abstract class ChannelAccessIFTest extends TestCase {
    ...
    protected Channel syncCreateChannel(String name, boolean waitForConnectEvent) {
    ...
    protected Channel syncCreateChannel(String name) {
    ...
    private class ChannelGetRequesterImpl implements ChannelGetRequester {
        ...
        public void waitAndCheckConnect(boolean expectedSuccess) {
            synchronized (this) {
                ...
                if (expectedSuccess) {
                    assertTrue("channel get failed to connect", connected);
                    assertNotNull(channelGet);
                    assertNotNull(structure);
                } else {
                    assertFalse("channel get has not failed to connect", connected);
                }
            }
        }
        ...
        public void syncGet(boolean lastRequest, boolean expectedSuccess) {
            synchronized (this) {
                if (connected == null)
                    fail("channel get not connected");
                ...
                if (expectedSuccess)
                    assertTrue("channel get failed", success);
                else
                    assertFalse("channel get has not failed", success);
            }
        }
    ...
    private class ChannelPutRequesterImpl implements ChannelPutRequester {
        ...
        public void waitAndCheckConnect(boolean expectedSuccess) {
            synchronized (this) {
                ...
                if (expectedSuccess) {
                    assertTrue("channel put failed to connect", connected);
                    assertNotNull(channelPut);
                    assertNotNull(structure);
                } else {
                    assertFalse("channel put has not failed to connect", connected);
                }
            }
        }
        ...
        public void syncGet() {
            synchronized (this) {
                if (connected == null)
                    fail("channel put not connected");
        ...
        public void syncPut(boolean lastRequest, PVStructure pvPutStructure, BitSet pvPutBitSet, boolean expectedSuccess) {
            synchronized (this) {
                ...
                if (expectedSuccess)
                    assertTrue("channel put failed", success);
                else
                    assertFalse("channel put has not failed", success);
            }
        }
    ...
    private class ChannelPutGetRequesterImpl implements ChannelPutGetRequester {
        ...
        public void syncPutGet(boolean lastRequest,
            ...
            synchronized (this) {
                if (connected == null) {
                    fail("channel put-get not connected");
                }
    ...
    private class ChannelRPCRequesterImpl implements ChannelRPCRequester {
        ...
        public PVStructure syncRPC(PVStructure arguments, boolean lastRequest, boolean expectedSuccess) {
            synchronized (this) {
                if (connected == null)
                    fail("channel rpc not connected");
    ...
    private class ChannelProcessRequesterImpl implements ChannelProcessRequester {
        ...
        public void syncProcess(boolean lastRequest, boolean expectedSuccess) {
            synchronized (this) {
                if (connected == null)
                    fail("channel process not connected");
    ...
    private class ChannelArrayRequesterImpl implements ChannelArrayRequester {
        ...
        public void syncGet(boolean lastRequest, int offset, int count, int stride, boolean expectedSuccess) {
            synchronized (this) {
                if (connected == null)
                    fail("channel array not connected");
    ...
    private void channelGetTestParameters(Channel ch) {
    ...
    private void channelGetTestNoConnection(Channel ch, boolean disconnect) {
        CreateRequest createRequest = CreateRequest.create();
        String request = "field(timeStamp,value)";
        PVStructure pvRequest = createRequest.createRequest(request);
        if (pvRequest == null) {
    ...
    private void channelGetTestNoProcess(Channel ch) {
        CreateRequest createRequest = CreateRequest.create();
        String request = "field(timeStamp,value)";
        PVStructure pvRequest = createRequest.createRequest(request);
        if (pvRequest == null) {
    ...
    private void channelGetTestIntProcess(Channel ch) throws Throwable {
        CreateRequest createRequest = CreateRequest.create();
    ...
    private void channelPutTestParameters(Channel ch) {
        CreateRequest createRequest = CreateRequest.create();
        String request = "field(timeStamp,value)";
        PVStructure pvRequest = createRequest.createRequest(request);
        if (pvRequest == null) {
    ...
    private void channelPutTestNoConnection(Channel ch, boolean disconnect) {
        CreateRequest createRequest = CreateRequest.create();
        String request = "field(timeStamp,value)";
        PVStructure pvRequest = createRequest.createRequest(request);
        if (pvRequest == null) {
    ...
    private void channelPutTestNoProcess(Channel ch) {
        CreateRequest createRequest = CreateRequest.create();
    ...
    private void channelPutTestIntProcess(Channel ch) {
        CreateRequest createRequest = CreateRequest.create();
    ...
    public void testChannelGetField() {
    ...
    public void testChannelProcess() {
        Channel ch = syncCreateChannel("simpleCounter");
    ...
    private void channelProcessTestNoConnection(Channel ch, boolean disconnect) {
        ChannelProcessRequesterImpl channelProcessRequester = new ChannelProcessRequesterImpl();
        ch.createChannelProcess(channelProcessRequester, null);
    ...
    public void testChannelPutGet() throws Throwable {
        ...
        channelPutGetTestNoProcess(ch);

        ch.destroy();

        ch = syncCreateChannel("simpleCounter");

        channelPutGetTestIntProcess(ch);
    ...
    private void channelPutGetTestParameters(Channel ch) {
        CreateRequest createRequest = CreateRequest.create();
    ...
    private void channelPutGetTestNoConnection(Channel ch, boolean disconnect) {
        CreateRequest createRequest = CreateRequest.create();
        String request = "putField(value)getField(timeStamp,value)";
        PVStructure pvRequest = createRequest.createRequest(request);
        if (pvRequest == null) {
    ...
    private void channelPutGetTestNoProcess(Channel ch) {
        CreateRequest createRequest = CreateRequest.create();
        String request = "putField(value)getField(timeStamp,value)";
        PVStructure pvRequest = createRequest.createRequest(request);
        if (pvRequest == null) {
    ...
    private void channelPutGetTestIntProcess(Channel ch) throws Throwable {
        CreateRequest createRequest = CreateRequest.create();
    ...
    private void channelRPCTestParameters(Channel ch) {
        CreateRequest createRequest = CreateRequest.create();
        String request = "";
        PVStructure pvRequest = createRequest.createRequest(request);
        if (pvRequest == null) {
    ...
    private void channelRPCTest(Channel ch) {
        ...
        ch.createChannelRPC(channelRPCRequester, null);
    ...
    private void channelRPCTestNoConnection(Channel ch, boolean disconnect) {
        PVStructure arguments = createRPCArguments();
    ...
    private void channelArrayTestParameters(Channel ch) {
        CreateRequest createRequest = CreateRequest.create();
    ...
    private void channelArrayTestNoConnection(Channel ch, boolean disconnect) {
        ChannelArrayRequesterImpl channelArrayRequester = new ChannelArrayRequesterImpl();
    ...
    public void testStressConnectDisconnect() {
        final int COUNT = 300;
    ...
    public void testStressConnectGetDisconnect() {
        final int COUNT = 300;
        for (int i = 1; i <= COUNT; i++) {
