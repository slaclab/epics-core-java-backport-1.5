...
public class RPCServiceClientExample {
    ...
    private static final StatusCreate statusCreator = StatusFactory.getStatusCreate();
    private static final Status UNSPECIFIED_ERROR = statusCreator.createStatus(Status.StatusType.WARNING, "unspecified error", null);
