...
public class NoSecurityPlugin implements SecurityPlugin, SecurityPlugin.SecuritySession, SecurityPlugin.ChannelSecuritySession {
    ...
    private static final Status statusOk = StatusFactory.getStatusCreate().getStatusOK();

    // TODO make it loggable (traces all the ops) - need to refactor the code to become stateful
