...
public class Getopt extends Object {
     ...
     */
    private ResourceBundle _messages = GetoptResourceBundle.INSTANCE;
     ...
     *
     * @param programName  The name to display as the program name when printing errors
     ...
     */
    public Getopt(String programName, String[] argv, String optstring,
     ...
     * how much of ARGV has been scanned so far.
     *
     * @return next element option index.
     */
    public int
    getOptind() {
        return (optind);
