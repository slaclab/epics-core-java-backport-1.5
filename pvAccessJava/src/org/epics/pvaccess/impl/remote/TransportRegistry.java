...
public final class TransportRegistry {
     ...
     */
    private final Map<InetSocketAddress, Map<Short, Transport>> transports;
     ...
     */
    public synchronized Transport get(InetSocketAddress address, short priority) {
        // TODO support type
        Map<Short, Transport> priorities = transports.get(address);
        if (priorities != null)
     ...
     */
    public synchronized Transport[] get(InetSocketAddress address) {
        // TODO support type
        Map<Short, Transport> priorities = transports.get(address);
        if (priorities != null) {
            // TODO optimize
