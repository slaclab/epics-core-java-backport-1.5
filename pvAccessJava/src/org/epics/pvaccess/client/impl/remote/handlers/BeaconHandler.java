...
public class BeaconHandler extends AbstractClientResponseHandler {
    ...
    public void handleResponse(InetSocketAddress responseFrom, Transport transport, byte version, byte command, int payloadSize, ByteBuffer payloadBuffer) {
        ...
        /*final byte qosCode = */
        payloadBuffer.get();
        final int sequentialID = payloadBuffer.get() & 0x000000FF;
        ...
        org.epics.pvaccess.client.impl.remote.BeaconHandler beaconHandler = null;

        if (protocol != null) {
            beaconHandler = context.getBeaconHandler(protocol, responseFrom);
        }
        ...
        beaconHandler.beaconNotify(responseFrom, version, timestamp, guid, sequentialID, changeCount, data);
    }
