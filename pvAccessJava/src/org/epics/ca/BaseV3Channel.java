...
public class BaseV3Channel implements
    ...
    public ConnectionState getConnectionState() {
        ...
        else if (connectionState == gov.aps.jca.Channel.ConnectionState.NEVER_CONNECTED)
    ...
    public void destroy() {
        ...
        try {
            ...
            if (channelRequester != null)
                channelRequester.message("destroy caused CAException " + e.getMessage(), MessageType.error);
        }
        jcaChannel = null;
    }
